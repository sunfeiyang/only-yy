...
public class Movie_Us_Box {
    ...
    //票房
    private String subject_box;

    //是否新上榜
    private String subject_new;
    ...
    public String getSubject_box() {
        return subject_box;
    }

    public void setSubject_box(String subject_box) {
        this.subject_box = subject_box;
    }

    public String getSubject_new() {
        return subject_new;
    }

    public void setSubject_new(String subject_new) {
