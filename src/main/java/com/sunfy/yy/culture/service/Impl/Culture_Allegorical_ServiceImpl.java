...
@Service
public class Culture_Allegorical_ServiceImpl extends Culture_ServiceImpl implements Culture_Allegorical_Service {

    private final static Logger logger = LoggerFactory.getLogger(Culture_Allegorical_ServiceImpl.class);
